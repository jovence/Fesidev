                        ...
                        <div class="content-box">
                            ...
                            <div class="text">
                                <p>On the other hand, we denounce with righteous indignation & dislike men who are so
                                    ...
                                    desire
                                    that they cannot foresee the pain trouble that are bound to ensure.</p>
                            </div>
                    ...
                    <div class="image_block_2">
                        <div class="image-box">
                            ...
                            <div class="rotate-text">
                                <figure class="text-box rotate-me"><img src="assets/images/icons/rotate-text-2.png"
                                        alt="">
                                </figure>
                            ...
                            <div class="tab-btn-box">
                                <ul class="tab-btns tab-buttons clearfix">
                                    <li class="tab-btn active-btn" data-tab="#tab-1"><i
                                            class="far fa-calendar-alt"></i>2005
                                    </li>
                                ...
                                <div class="tab active-tab" id="tab-1">
                                    <div class="text">
                                        ...
                                        <p>Denounce with righteous indignation & dislike men who are so beguiled and
                                            ...
                                            that
                                            they cannot foresee the pain.</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one">
                        <div class="inner-box">
                            ...
                            <h3>Our Vision</h3>
                            <p>Our power of choice untrammelled and when nothing prevents our being able to do what we
                                like
                                best.</p>
                            <div class="btn-box"><a href="about.html" class="theme-btn btn-one">Read More</a></div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one">
                        <div class="inner-box">
                            ...
                            <h3>Our Goal</h3>
                            <p>Duty or the obligations of business it will frequently occurs that pleasures have
                                repudiated
                                annoyances.</p>
                            <div class="btn-box"><a href="about.html" class="theme-btn btn-one">Read More</a></div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one">
                        <div class="inner-box">
                            ...
                            <h3>Our Partners</h3>
                            <p>Riighteous indignation and dislike men who are so beguiled and demoralized by the
                                pleasure of
                                the moment.</p>
                            <div class="btn-box"><a href="about.html" class="theme-btn btn-one">Read More</a></div>
                        </div>
                ...
                <div class="team-block-one">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            ...
                            <figure class="thumb-box"><img src="assets/images/team/team-5.png" alt=""></figure>
                            <div class="text">
                                <p>He rejects pleasures to secure other greater pleasures or else he endures.</p>
                            </div>
                        </div>
